...
INSERT INTO `articles_category_links` VALUES (8,13),(2,2),(10,10),(5,4),(3,4),(6,5),(11,9);
...
INSERT INTO `categories` VALUES (2,'nature','nature','2022-07-09 08:49:37.859000','2022-07-27 16:33:12.018000',NULL,1,'en'),(3,'tech','tech','2022-07-09 08:49:37.862000','2022-07-25 10:04:06.879000',NULL,NULL,'en'),(4,'history','history','2022-07-09 08:49:37.864000','2022-08-02 00:44:16.719000',NULL,1,'en'),(5,'food','food','2022-07-09 08:49:37.867000','2022-08-02 08:58:35.578000',NULL,1,'en'),(9,'alimento','alimento','2022-07-25 10:02:35.436000','2022-08-02 08:59:03.611000',1,1,'es'),(10,'naturaleza','naturaleza','2022-07-25 10:02:58.054000','2022-07-27 16:33:26.905000',1,1,'es'),(12,'tecnología','tecnologia','2022-07-25 10:04:06.673000','2022-07-25 10:04:06.673000',1,1,'es'),(13,'historia','historia','2022-07-25 19:26:18.288000','2022-07-25 19:26:18.288000',1,1,'es');
...
INSERT INTO `navs` VALUES (1,'HOME','2022-07-30 01:21:16.908000','2022-08-02 00:32:15.956000','2022-07-30 01:21:18.276000',1,1,'en','first'),(2,'PRINCIPAL','2022-07-30 01:21:40.437000','2022-08-02 00:32:23.355000','2022-07-30 01:21:41.811000',1,1,'es','first'),(3,'ABOUT','2022-07-30 01:21:54.520000','2022-08-02 00:32:37.728000','2022-07-30 01:21:55.302000',1,1,'en','second'),(4,'SOBRE NOSOTROS','2022-07-30 01:22:11.881000','2022-08-02 00:32:42.371000','2022-07-30 01:22:13.253000',1,1,'es','second'),(5,'OUR TEAM','2022-07-30 01:22:30.921000','2022-08-02 00:32:53.606000','2022-07-30 01:22:31.638000',1,1,'en','third'),(6,'NUESTRO EQUIPO','2022-07-30 01:22:45.120000','2022-08-02 00:32:58.616000','2022-07-30 01:22:46.209000',1,1,'es','third'),(7,'BLOG','2022-07-30 01:23:15.585000','2022-08-02 00:33:15.115000','2022-07-30 01:23:16.275000',1,1,'en','four'),(8,'BLOG','2022-07-30 01:25:18.364000','2022-08-02 00:33:27.038000','2022-07-30 01:25:20.408000',1,1,'es','four');
...
CREATE TABLE `teams` (
  ...
  `slug` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `teams_created_by_id_fk` (`created_by_id`),
  KEY `teams_updated_by_id_fk` (`updated_by_id`),
  CONSTRAINT `teams_created_by_id_fk` FOREIGN KEY (`created_by_id`) REFERENCES `admin_users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `teams_updated_by_id_fk` FOREIGN KEY (`updated_by_id`) REFERENCES `admin_users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `teams` VALUES (1,'Ramon','2022-07-30 09:16:20.380000','2022-07-30 09:26:33.677000','2022-07-30 09:16:21.602000',1,1,'en','boss','This is an example','ramon'),(2,'Ramon','2022-07-30 09:16:42.539000','2022-07-30 09:26:18.974000','2022-07-30 09:16:43.895000',1,1,'es','Jefe','esto es un ejemplo','ramon');
/*!40000 ALTER TABLE `teams` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `teams_localizations_links`
--

DROP TABLE IF EXISTS `teams_localizations_links`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `teams_localizations_links` (
  `team_id` int unsigned DEFAULT NULL,
  `inv_team_id` int unsigned DEFAULT NULL,
  KEY `teams_localizations_links_fk` (`team_id`),
  KEY `teams_localizations_links_inv_fk` (`inv_team_id`),
  CONSTRAINT `teams_localizations_links_fk` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`) ON DELETE CASCADE,
  CONSTRAINT `teams_localizations_links_inv_fk` FOREIGN KEY (`inv_team_id`) REFERENCES `teams` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `teams_localizations_links`
--

LOCK TABLES `teams_localizations_links` WRITE;
/*!40000 ALTER TABLE `teams_localizations_links` DISABLE KEYS */;
INSERT INTO `teams_localizations_links` VALUES (2,1),(1,2);
/*!40000 ALTER TABLE `teams_localizations_links` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `up_permissions_role_links` VALUES (1,1),(2,1),(9,2),(5,2),(11,2),(6,2),(12,2),(19,2),(14,2),(15,2),(18,2),(17,2),(13,2),(16,2),(20,2),(21,2),(23,2),(24,2),(26,2),(25,2),(28,2),(27,2);
...
INSERT INTO `up_roles` VALUES (1,'Authenticated','Default role given to authenticated user.','authenticated','2022-07-09 08:49:34.445000','2022-07-09 08:49:34.445000',NULL,NULL),(2,'Public','Default role given to unauthenticated user.','public','2022-07-09 08:49:34.570000','2022-07-30 09:15:05.759000',NULL,NULL);
...
-- Dump completed on 2022-08-02 19:51:06
